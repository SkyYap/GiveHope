...
export const Dashboard: React.FC = () => {
  ...
  const myDonationHistory = [
    { id: 1, ngo: 'Clean Water Initiative', amount: 500, date: '2024-01-15', status: 'completed', impact: '12 people helped', avatar: 'https://images.pexels.com/photos/2260655/pexels-photo-2260655.jpeg' },
    { id: 2, ngo: 'Education for All', amount: 1000, date: '2024-01-10', status: 'completed', impact: '3 children educated', avatar: 'https://images.pexels.com/photos/3184428/pexels-photo-3184428.jpeg' },
    { id: 3, ngo: 'Healthcare Access', amount: 250, date: '2024-01-05', status: 'completed', impact: '5 treatments provided', avatar: 'https://images.pexels.com/photos/4033148/pexels-photo-4033148.jpeg' },
    { id: 4, ngo: 'Environmental Protection', amount: 750, date: '2023-12-28', status: 'completed', impact: '20 trees planted', avatar: 'https://images.pexels.com/photos/347140/pexels-photo-347140.jpeg' },
    { id: 5, ngo: 'Youth Empowerment', amount: 300, date: '2023-12-20', status: 'completed', impact: '8 youth trained', avatar: 'https://images.pexels.com/photos/167682/pexels-photo-167682.jpeg' }
  ];
  ...
  const donationData = [
    { month: 'Jan', amount: 45000, donors: 120, myDonations: 500 },
    { month: 'Feb', amount: 52000, donors: 145, myDonations: 750 },
    { month: 'Mar', amount: 48000, donors: 132, myDonations: 300 },
    { month: 'Apr', amount: 61000, donors: 167, myDonations: 1000 },
    { month: 'May', amount: 55000, donors: 151, myDonations: 600 },
    { month: 'Jun', amount: 67000, donors: 189, myDonations: 800 },
    { month: 'Jul', amount: 73000, donors: 203, myDonations: 450 },
    { month: 'Aug', amount: 69000, donors: 195, myDonations: 900 },
    { month: 'Sep', amount: 78000, donors: 218, myDonations: 650 },
    { month: 'Oct', amount: 82000, donors: 234, myDonations: 1200 },
    { month: 'Nov', amount: 89000, donors: 251, myDonations: 800 },
    { month: 'Dec', amount: 95000, donors: 267, myDonations: 1100 }
  ];
  ...
  const donorImpactMetrics = [
    ...
    { label: 'NGOs Supported', value: 12, icon: Building2, color: 'text-green-600', bg: 'bg-green-50' },
    { label: 'Impact Points', value: 2340, icon: Star, color: 'text-purple-600', bg: 'bg-purple-50' },
    { label: 'Donor Rank', value: 847, icon: Trophy, color: 'text-orange-600', bg: 'bg-orange-50', prefix: '#' }
  ];
  ...
  const donorTabs = [
    ...
    { id: 'supported-ngos', label: 'Supported NGOs', icon: Building2 },
          ...
          {userRole === 'ngo' ? (
            ...
            <>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="flex items-center mt-2 text-green-100">
                      ...
                      <span className="text-sm">{donorStats.favoriteCategory} focus</span>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="flex items-center mt-2 text-purple-100">
                      ...
                      <span className="text-sm">{donorStats.donationStreak} day streak</span>
                    </div>
                  </div>
              ...
              <Card className="p-6 bg-gradient-to-br from-orange-500 to-orange-600 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-orange-100 text-sm font-medium">Donor Rank</p>
                    <div className="text-2xl font-bold">
                      <AnimatedCounter value={currentStats.rankPosition} prefix="#" />
                    </div>
                    <div className="flex items-center mt-2 text-orange-100">
                      <Trophy className="w-4 h-4 mr-1" />
                      <span className="text-sm">{donorStats.totalImpact} people helped</span>
                    </div>
                  </div>
          ...
          {userRole === 'donor' && (
            <>
              {activeTab === 'overview' && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="lg:col-span-2 space-y-8">
                    ...
                    <Card className="p-6">
                      <div className="flex items-center justify-between mb-6">
                        <h3 className="text-xl font-semibold text-gray-900">My Donation History</h3>
                        <select
                          value={timeRange}
                          onChange={(e) => setTimeRange(e.target.value)}
                      ...
                      <ResponsiveContainer width="100%" height={300}>
                        <AreaChart data={donationData}>
                          ...
                          <XAxis dataKey="month" />
                          <YAxis />
                          <Tooltip formatter={(value) => [`RM ${value.toLocaleString()}`, 'My Donations']} />
                          <Area type="monotone" dataKey="myDonations" stroke="#3b82f6" fill="#3b82f6" fillOpacity={0.6} />
                        </AreaChart>
                      </ResponsiveContainer>
                    </Card>
                    ...
                    <Card className="p-6">
                      ...
                      <div className="space-y-4">
                        {myDonationHistory.slice(0, 5).map((donation) => (
                          <div key={donation.id} className="border border-gray-200 rounded-lg p-4">
                            <div className="flex items-center space-x-4">
                              ...
                              <div className="flex-1">
                                ...
                                <div className="flex items-center justify-between text-sm text-gray-600">
                                  <span>RM {donation.amount.toLocaleString()}</span>
                                  <span>{donation.date}</span>
                                </div>
                                <p className="text-sm text-blue-600 font-medium mt-1">{donation.impact}</p>
                              </div>
                              <div className="flex space-x-2">
                                <Button variant="ghost" size="sm">
                                  <Eye className="w-4 h-4" />
                    ...
                    {supportedNGOs.map((ngo) => (
                      <Card key={ngo.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                        <div className="relative h-48">
                          ...
                          <div className="absolute top-3 right-3">
                            <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                              ngo.status === 'active' ? 'bg-green-500 text-white' : 'bg-blue-500 text-white'
                            }`}>
                              {ngo.status}
                            </span>
                          </div>
                ...
                <div className="space-y-8">
                  <div className="text-center">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                      See the real-world difference your donations are making in communities worldwide
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <Card className="p-6">
                      <h3 className="text-xl font-semibold text-gray-900 mb-6">Impact Stories</h3>
                      <div className="space-y-4">
                        <div className="border-l-4 border-blue-500 pl-4">
                          <h4 className="font-semibold text-gray-900">Clean Water Access</h4>
                          <p className="text-sm text-gray-600 mt-1">
                            Your donations helped provide clean water access to 36 people across 3 villages.
                          </p>
                          <span className="text-xs text-blue-600 font-medium">From your RM 1,500 donations</span>
                        </div>
                        <div className="border-l-4 border-green-500 pl-4">
                          <h4 className="font-semibold text-gray-900">Education Support</h4>
                          <p className="text-sm text-gray-600 mt-1">
                            Funded education materials and school supplies for 8 children.
                          </p>
                          <span className="text-xs text-green-600 font-medium">From your RM 2,000 donations</span>
                        </div>
                        <div className="border-l-4 border-purple-500 pl-4">
                          <h4 className="font-semibold text-gray-900">Healthcare Support</h4>
                          <p className="text-sm text-gray-600 mt-1">
                            Enabled 15 medical treatments in underserved communities.
                          </p>
                          <span className="text-xs text-purple-600 font-medium">From your RM 750 donations</span>
                        </div>
                      </div>
                    </Card>
                  </div>
              ...
              {activeTab === 'discover' && (
                <div className="space-y-6">
                  <div className="text-center">
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">Discover New NGOs</h2>
                    <p className="text-gray-600 mb-6">Find new causes to support and expand your impact</p>
                    <Link to="/discover">
